...
async def translate_sync(
	...
	save_translated_arxiv: SaveTranslatedArxivUsecase = Depends(get_save_translated_arxiv),
	...
	# 4. 翻訳済みの論文として保存
	arxiv_paper_metadata_with_translated_url = await save_translated_arxiv.save_translated_arxiv(
		arxiv_paper_id=ArxivPaperId(root=arxiv_paper_id),
...
async def translate(
	...
	async def run_workflow():
		...
		yield ServerSentEvent(data=arxiv_paper_metadata_with_translated_url.translated_url)
