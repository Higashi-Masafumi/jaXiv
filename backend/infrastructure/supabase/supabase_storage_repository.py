...
class SupabaseStorageRepository(IFileStorageRepository):
	...
	async def save_translated_latex_file_and_get_url(
		...
		"""
		self._logger.info('Saving translated latex file %s', translated_latex_file.storage_path)
		# 1. クライアントの初期化
		...
		# 3. ファイルのURLの取得
		self._logger.info('Saved translated latex file %s', translated_latex_file.storage_path)
